    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{route('admin.dashboard')}}" class="sidebar__main-logo">
                <h2 style="color:white">Unicus</h2>
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <!-- <li class="sidebar-menu-item {{menuActive('admin.manage.home')}}">
                    <a href="{{route('admin.manage.home')}}" class="nav-link ">
                        <i class="menu-icon las la-home"></i>
                        <span class="menu-title">@lang('Manage Home Page')</span>
                    </a>
                </li> -->

                <li class="sidebar-menu-item {{menuActive('admin.manage.social-links')}}">
                    <a href="{{route('admin.manage.social-links')}}" class="nav-link ">
                        <i class="menu-icon las la-globe"></i>
                        <span class="menu-title">@lang('Manage Social Links')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item  {{menuActive('admin.slider.index')}}">
                    <a href="{{route('admin.slider.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.slider.index') }}">
                        <i class="menu-icon las la-ring"></i>
                        <span class="menu-title">@lang('Manage Slider')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item  {{menuActive('admin.top-banner')}}">
                    <a href="{{route('admin.top-banner')}}" class="nav-link"
                       data-default-url="{{ route('admin.top-banner') }}">
                        <i class="menu-icon las la-ring"></i>
                        <span class="menu-title">@lang('Top Banner')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item  {{menuActive('admin.policy-page.index')}}">
                    <a href="{{route('admin.policy-page.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.policy-page.index') }}">
                        <i class="menu-icon las la-ring"></i>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.articles')}}">
                    <a href="{{route('admin.articles')}}" class="nav-link"
                       data-default-url="{{ route('admin.articles') }}">
                        <i class="menu-icon las la-edit"></i>
                        <span class="menu-title">@lang('Manage Articles')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item  {{menuActive('admin.blogs')}}">
                    <a href="{{route('admin.blogs')}}" class="nav-link"
                       data-default-url="{{ route('admin.blogs') }}">
                        <i class="menu-icon las la-ring"></i>
                        <span class="menu-title">@lang('Manage Blog')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item  {{menuActive('admin.partners.index')}}">
                    <a href="{{route('admin.partners.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.partners.index') }}">
                        <i class="menu-icon las la-users"></i>
                        <span class="menu-title">@lang('Manage Partner')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item  {{menuActive('admin.collections.index')}}">
                    <a href="{{route('admin.collections.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.collections.index') }}">
                        <i class="menu-icon las la-stream"></i>
                        <span class="menu-title">@lang('Manage Collections')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.category*',2)}} ">
                        <ul>
                            ...
                            <!-- <li class="sidebar-menu-item {{menuActive('admin.community-category.index')}} ">
                                <a href="{{route('admin.community-category.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Community Category')</span>
                                </a>
                            </li> -->
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.product*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.product.start')}} ">
                                <a href="{{route('admin.product.start')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Start Auction')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.product.started')}} ">
                                <a href="{{route('admin.product.started')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Started Auction')</span>
                                </a>
                            </li>


                            <li class="sidebar-menu-item {{menuActive('admin.product.end_auction')}} ">
                                <a href="{{route('admin.product.end_auction')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('End Auction')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.product.processed')}} ">
                                <a href="{{route('admin.product.processed')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Ended Auction')</span>
                                </a>
                            </li>
            
                            <li class="sidebar-menu-item {{menuActive('admin.dashboard')}}">
                                <a href="{{route('admin.sold-out')}}" class="nav-link ">
                                    <i class="menu-icon las la-home"></i>
                                    <span class="menu-title">@lang('Sold Out')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.dashboard')}}">
                                <a href="{{route('admin.product.product-biddings')}}" class="nav-link ">
                                    <i class="menu-icon las la-home"></i>
                                    <span class="menu-title">@lang('Product Biddings')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.transactions*')}}">
                    <a href="{{route('admin.transactions.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.transactions.index') }}">
                        <i class="menu-icon lab la-adversal"></i>
                        <span class="menu-title">@lang('Product Transactions')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item  {{menuActive('admin.transactionPayments*')}}">
                    <a href="{{route('admin.transactionPayments.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.transactionPayments.index') }}">
                        <i class="menu-icon lab la-adversal"></i>
                        <span class="menu-title">@lang('Product Transactions Payment')</span>
                    </a>
                </li>
<!-- 
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.withdraw*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.withdraw.approved')}} ">
                                <a href="{{route('admin.withdraw.withdraw-amounts')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Withdraw Amounts')</span>
                                </a>
                            </li>
                          
                            <li class="sidebar-menu-item {{menuActive('admin.withdraw.approved')}} ">
                                <a href="{{route('admin.withdraw.withdraw-transactions')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Withdraw Transactions')</span>
                                </a>
                            </li>
