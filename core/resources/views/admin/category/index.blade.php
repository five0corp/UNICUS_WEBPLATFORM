                            ...
                            @forelse($categorys as $category)
                                <tr>
                                    ...
                                    <td data-label="@lang('Image')">
                                        ...
                                        <img src="{{ asset('assets/images/category/'.$category->image) }}" width="100">
                                    </td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="javascript:void(0)" class="icon-btn btn--primary ml-1 updateCity"
                                            ...
                                            data-image="{{ asset('assets/images/category/'.$category->image) }}"
                                            data-status ="{{$category->status}}"
                                        ><i class="las la-pen"></i></a>
                                        <a href="{{ route('admin.category.delete',$category->id) }}" class="icon-btn btn--primary ml-1" data-id="{{$category->id}}"><i class="las la-trash"></i></a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.category.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="name" class="form-control-label font-weight-bold">@lang('Image') (500*500)</label>
...
<script>
    ...
    $('.updateCity').on('click', function() {
        ...
        modal.find('#view-image').attr('src',$(this).data('image'));
