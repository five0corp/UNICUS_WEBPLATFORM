            ...
            <form action="{{route('admin.product.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <span class="input-group-text" id="basic-addon2" style="padding:0px; ">    
                                    <select class="form-control  form--control-2 " name="symbol" id="symbol" required="" >
                                        <!-- <option value="{{-- $general->cur_text --}}">{{-- $general->cur_text --}}</option> -->
                                        <option value="{{ old('symbol', 'UNIC') }}">{{__('UNIC')}}</option>
                                        <option value="{{ old('symbol', 'ETH') }}" >{{__('ETH')}}</option>
                                    </select>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-12 col-md-6">
                      ...
                      <select class="form-control form--control-2" id="created_by" name="created_by" required>
                            <option value="">@lang('Select One')</option>
                            @foreach($collections as $collection)
                                <option value="{{ $collection->id }}">{{ $collection->name }}</option>
                            @endforeach
                      </select>
                        <!-- <input class="form-control form--control-2" id="created_by" type="text" maxlength="255" name="created_by" value="{{ old('created_by') }}" placeholder="@lang('Enter Created By')" required=""> -->
                    </div>
                    ...
                    <div class="form-group col-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="latest" value="1" id="flexCheckDefault2">
