        ...
        <div class="card b-radius--10 ">
            ...
            <form action="{{route('admin.product.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <?php if($product->start_price){
                                ...
                                <input type="text" class="form-control form--control-2" id="start_price" value="{{ $start_price }}" name="start_price" placeholder="@lang('Enter Start Price')" aria-label="Recipient's username" aria-describedby="basic-addon2" required="">
                                <span class="input-group-text" id="basic-addon2" style="padding:0px; ">    
                                    <select class="form-control  form--control-2 " name="symbol" id="symbol" required="" >
                                       <!-- <option value="{{$general->cur_text}}"  <?php /*echo ($product->symbol=="USD") ? "selected" : ""; */?>>{{-- $general->cur_text --}}</option> -->
                                        <option value="UNIC" <?php echo ($product->symbol=="UNIC") ? "selected" : ""; ?>>{{__('UNIC')}}</option>
                                        <option value="ETH" <?php echo ($product->symbol=="ETH") ? "selected" : ""; ?>>{{__('ETH')}}</option>
                                    </select>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-12 col-md-6">
                        <label class="form-control-label font-weight-bold">@lang('Thumb Image') (500*500) </label>
                    ...
                    <div class="form-group col-12 col-md-6">
                    <?php if($product->glb_filename){
                            $glb_image=$product->glb_filename;
                        }else{
                            $glb_image='';
                        }
                        ?>
                        <label class="form-control-label font-weight-bold">@lang('GLB Image / Video / Image ') </label>
                        <input class="form-control form--control-2" type="file" id="glb_file" name="image_hash">
                        @if($glb_image!="")
                            @if($product->image_type=='G')
                            <model-viewer src="{{ asset('assets/images/product').'/'.$glb_image }}" style="width:100px;height:100px;padding:10px;background:#fff" auto-rotate camera-controls alt="cube" background-color="#455A64"></model-viewer>
                            @elseif($product->image_type=='I')
                            <img src="{{ asset('assets/images/product').'/'.$glb_image }}" width="100px"/>
                            @else
                    ...
                    <div class="form-group col-12 col-md-6">
                        <label class="form-control-label font-weight-bold">@lang('Created By') </label>
                      ...
                      <select class="form-control  form--control-2" name="created_by" id="created_by" required="">
                                <option value="">@lang('Select One')</option>
                                @foreach($collections as $collection)
                                <option value="{{$collection->id}}" <?php echo ($product->created_by==$collection->id) ? "selected" : ""; ?> >{{__($collection->name)}}</option>
                                @endforeach
                            </select>

                        <!-- <input class="form-control form--control-2" id="created_by" type="text" maxlength="255" name="created_by" value="{{ $created_by }}" placeholder="@lang('Enter Created By')" required=""> -->
                    </div>
                    ...
                    <div class="form-group col-12 col-md-12">
                        ...
                        <?php if($product->latest){
                            ...
                            <input class="form-check-input" type="checkbox" name="latest" value="1" id="flexCheckDefault2" <?php echo ($latest==1) ? "checked" : ""; ?>>
