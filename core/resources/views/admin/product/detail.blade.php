            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Start Price')
                            <span class="font-weight-bold">{{getAmount($product->start_price)}} {{$product->symbol}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Sale Price')
                            <span class="font-weight-bold">{{getAmount($product->sale_price)}} {{$product->symbol}}</span>
                        </li>
