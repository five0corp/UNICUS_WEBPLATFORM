                ...
                <div class="col-lg-6 left-side">
                    <div class="account-logo">
                        <div class="logo">
                            <a href="{{route('home')}}">
                                ...
                                <h3 style="color:#000">{{$general->sitename}}</h3>
                            </a>
                        </div>
                    ...
                    <form class="account-form" action="{{ route('user.register') }}" method="POST" onsubmit="return submitUserForm();">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="username" class="form--label">@lang('Nickname')</label>
...
<!-- 
                            ...
                            <!-- <div class="form-group col-md-6">
                                ...
                                <div class="input-group ">
                                    <span class="input-group-text mobile-code bg--transparent p-0 pe-2 m-0"></span>
