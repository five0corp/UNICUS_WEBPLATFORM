...
class AdminController extends Controller
{
    ...
    public function sold_out(Request $request) {
        $products = ProductBidding::selectRaw('products.symbol, products.title as product_name, SUM(bid_amount) as bid_amount, users.firstname as username, products.updated_at as sold_at')
        ...
        $pageTitle = 'Sold Out';
        return view('admin.sold_out', compact('pageTitle', 'products'));
    }
    ...
    public function transaction_details(Request $request, $id) {
        ...
        // return $data;
        return view('admin.transaction_details', compact('pageTitle', 'data'));
    }
